...
#define VITATOOLBOX_VERSION_MAJOR 0x01
#define VITATOOLBOX_VERSION_MINOR 0x21

#define VITASHELL_VERSION ((VITATOOLBOX_VERSION_MAJOR << 0x18) | (VITATOOLBOX_VERSION_MINOR << 0x10))

#define VITASHELL_LASTDIR "ux0:VitaToolBox/internal/lastdir.txt"
