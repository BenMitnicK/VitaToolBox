...
INCLUDE_EXTERN_RESOURCE(preview_png);
...
INCLUDE_EXTERN_RESOURCE(settings_ini);
...
static DefaultFile default_files[] = {
	DEFAULT_FILE("ux0:VitaToolBox/language/english_us.ini", english_us_ini, 0),

	//DEFAULT_FILE("ux0:VitaToolBox/theme/theme.txt", theme_txt, 0),
	DEFAULT_FILE("ux0:VitaToolBox/settings.ini", settings_ini, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/colors.ini", colors_ini, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/param.ini", param_ini, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/folder_icon.png", folder_icon_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/file_icon.png", file_icon_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/archive_icon.png", archive_icon_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/image_icon.png", image_icon_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/audio_icon.png", audio_icon_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/sfo_icon.png", sfo_icon_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/text_icon.png", text_icon_png, 0),
	// DEFAULT_FILE("ux0:VitaToolBox/theme/Default/wifi.png", wifi_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/bg_browser.png", bg_browser_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/bg_hexeditor.png", bg_hexeditor_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/bg_texteditor.png", bg_texteditor_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/bg_photoviewer.png", bg_photoviewer_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/bg_audioplayer.png", bg_audioplayer_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/bg_selecttheme.png", bg_selecttheme_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/context.png", context_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/context_more.png", context_more_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/dialog.png", dialog_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/preview.png", preview_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/ftp.png", ftp_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/battery.png", battery_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/battery_bar_red.png", battery_bar_red_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/battery_bar_green.png", battery_bar_green_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/battery_bar_charge.png", battery_bar_charge_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/cover.png", cover_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/play.png", play_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/pause.png", pause_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/fastforward.png", fastforward_png, 0),
	DEFAULT_FILE("ux0:VitaToolBox/theme/Default/fastrewind.png", fastrewind_png, 0),

	DEFAULT_FILE("ux0:VitaToolBox/module/usbdevice.skprx", usbdevice_skprx, 1),

	DEFAULT_FILE("ux0:patch/VITATOOLS/sce_sys/changeinfo/changeinfo.xml", changeinfo_txt, 1),
};
...
void initVitaShell() {
	...
	sceIoMkdir("ux0:VitaToolBox", 0777);
	sceIoMkdir("ux0:VitaToolBox/internal", 0777);
	sceIoMkdir("ux0:VitaToolBox/language", 0777);
	sceIoMkdir("ux0:VitaToolBox/module", 0777);
	sceIoMkdir("ux0:VitaToolBox/theme", 0777);
	sceIoMkdir("ux0:VitaToolBox/theme/Default", 0777);

	sceIoMkdir("ux0:patch", 0777);
	sceIoMkdir("ux0:patch/VITATOOLS", 0777);
	sceIoMkdir("ux0:patch/VITATOOLS/sce_sys", 0777);
	sceIoMkdir("ux0:patch/VITATOOLS/sce_sys/changeinfo", 0777);
